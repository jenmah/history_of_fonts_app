...
gill_sans = Font.create(font_name: "Gill Sans", year_released: 1928, classification: "sans-serif", history: "Gill Sans is a sans-serif typeface designed by Eric Gill. The original design appeared in 1926 when Douglas Cleverdon opened a bookshop in his home town of Bristol, where Gill painted the fascia over the window in sans-serif capitals that would later be known as Gill Sans. Gill further developed it into a complete font family after Stanley Morison of Monotype commissioned the development of Gill Sans to compete with the sans-serif Erbar, Futura and Kabel families, which were being launched in Germany during the latter 1920s.", designed_by: 'Eric Gill', inspired_by: 'Johnston')
