...
roboto = Font.create(font_name: "Roboto", year_released: 2011, classification: "sans-serif", history: "Roboto has a dual nature. It has a mechanical skeleton and the forms are largely geometric. At the same time, the font features friendly and open curves. While some grotesks distort their letterforms to force a rigid rhythm, Roboto doesn’t compromise, allowing letters to be settle in to their natural width. This makes for a more natural reading rhythm more commonly found in humanist and serif types.", designed_by: 'Christian Robertson', inspired_by: 'Ubuntu-Title')
...
gill_sans = Font.create(font_name: "Gill Sans", year_released: 1928, classification: "sans-serif", history: "Gill Sans is a sans-serif typeface designed by Eric Gill. The original design appeared in 1926, when Douglas Cleverdon opened a bookshop in his home town of Bristol, where Gill painted the fascia over the window in sans-serif capitals that would later be known as Gill Sans. Gill further developed it into a complete font family after Stanley Morison of Monotype commissioned the development of Gill Sans to compete with the sans-serif Erbar, Futura and Kabel families. The popularity of Gill Sans influenced many other typefaces, and helped to define the genre of the humanist sans-serif.", designed_by: 'Eric Gill', inspired_by: 'Johnston')

open_sans = Font.create(font_name: "Open Sans", year_released: 2011, classification: "sans-serif", history: "Open Sans is a sans-serif typeface designed by Steve Matteson and commissioned by Google. According to Google, it was developed with an upright stress, open forms and a neutral, yet friendly appearance and is optimized for legibility across print, web, and mobile interfaces. Its design is almost identical to that of Droid Sans, with the exception of wider characters and the inclusion of italic variants. Open Sans is used in some of Google's web pages as well as its print and web advertisements.", designed_by: 'Steve Matteson', inspired_by: 'Droid Sans')
